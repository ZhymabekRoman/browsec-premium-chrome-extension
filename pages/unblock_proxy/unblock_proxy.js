  ...
  <div class="Body"><div class="In">
    ...
    ${(()=>this.hasManagement?c.dy`
      ...
      ${this.extensions.map((e=>c.dy`
        ...
        <div class="Extensions_Button"><button class="btn" @click="${this.disableExtensions}">
          ${d.disableSelectedExtensions}
        </button></div>
      </div>`:c.dy`
      <div class="SettingsBlocked">
        <div class="SettingsBlocked_Title">
          ${d.yourProxySettingsAreBlocked}
        </div>
        <p>
    ...
    <div class="Box success">
      ...
      <div class="Box_Success_Text">
        ${d.continueUsingBrowsecToOpenWebsites}
      </div>
    ...
    <div class="Box error">
      ...
      <div class="Box_Error_Text">
        ${d.pleaseTryAgainOrContactSupport}
      </div>
